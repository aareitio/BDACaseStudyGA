...
# Step 5: Run the following code with the information that is displayed in the fields {}:
 client.id <- "{434607760032-jg4c2mkpbb4665a67ct4bo2b05u6feho.apps.googleusercontent.com}"
 client.secret <- "{8feobon4os7K9NwmsCfC0Hi3}"
...
# 
# Create the report
source(paste(local_directory,"/RunStudy_ANDY.R", sep = "/"))
# 